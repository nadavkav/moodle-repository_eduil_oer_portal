...
/**
 * repository_eduil_oer_portal is used to search gadol.edu.gov.il in moodle
 *
 * @since 2.3
 * @package    repository
 ...
 */
class repository_eduil_oer_portal extends repository {
...
//        $author->label = get_string('author', 'search').': ';
    ...
    public static function type_config_form($mform, $classname = 'repository') {
        ...
        $licensekey = get_config('eduil_oer_portal', 'licensekey');
        if (empty($licensekey)) {
            $licensekey = '';
        }
